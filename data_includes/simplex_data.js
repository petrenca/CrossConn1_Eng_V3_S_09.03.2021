...
//PennController.Sequence( "instructions", randomize("practice_trials"),shuffle(randomize("critical_trials"),randomize("filler_trials")),"demographics","post_questionnaire",  "send", "final");
PennController.Sequence("demographics", "practice_trials", "instructions", shuffle(randomize("critical_trials"),randomize("filler_trials")),"end_experiment", "post_questionnaire", "send", "final");
...
PennController("demographics",
               ...
               newText("intro_instructions", "<p>This experiment investigates how people process linguistic information.<p>"
                       ...
                       +"<li> Please don’t take breaks during the experiment. The experiment should take 10-20 minutes. If you take longer than 25 minutes, we can't use your data and you will not be compensated.<br>"
